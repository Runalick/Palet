...
public class PreExhibitionDTO {
	...
	public PreExhibitionDTO() {}
	
	


	public PreExhibitionDTO(int pe_seq, String pe_img, String pe_name, String pe_contents, String pe_support,
			String pe_date, String pe_price, String pe_writer, String pe_artcount) {
		super();
		this.pe_seq = pe_seq;
		this.pe_img = pe_img;
