...
public class ProticketDTO {
	private String pro_email;
	private String pro_title;
	private String pro_place;
	private String pro_date;
	private String pro_booknumber;
	private String pro_state;
	private String pro_username;
	private String pro_phone;
	private String pro_paymethod;
	private String pro_cardnumber;
	private String pro_cardquota;
	private int pro_cost;
	private int pro_count;
	private int pro_point;
	private int pro_usedpoint;
	private int pro_cpdiscount;
	...
	public ProticketDTO(String pro_email, String pro_title, String pro_place, String pro_date, String pro_booknumber,
			String pro_state, String pro_username, String pro_phone, String pro_paymethod, String pro_cardnumber,
			String pro_cardquota, int pro_cost, int pro_count, int pro_point, int pro_usedpoint, int pro_cpdiscount,
			String pro_cpserial, Timestamp pro_buydate, String pro_category) {
		super();
