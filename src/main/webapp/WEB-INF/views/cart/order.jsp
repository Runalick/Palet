...
<!-- 				배송지 부분 -->
				...
				<div class="row delivery-area" style="height:34.875rem; width:49.25rem;">
					...
					<div class="col-12" style="text-align:left;">
						...
						<input type="text" class="body2 inputcode buyer_postcode1 " id="sample4_postcode" onclick="sample4_execDaumPostcode()" placeholder="우편번호 검색" value="${dto.postcode }" readonly style="padding-left:0.7rem;" > 
						<input type="text" class="body2 inputaddress buyer_addr1 address1" id="sample4_roadAddress"  placeholder="주소: 우편번호를 먼저 검색해 주세요." disabled value="${dto.address1 }" style="padding-left:0.7rem;">
						<input type="text" class="body2 inputaddress buyer_address21"  placeholder="상세 주소 : 우편번호를 먼저 검색해 주세요." id="sample4_detailAddress"  value="${dto.address2 }"  maxlength="20" style="padding-left:0.7rem;">
					</div>
					<div class="col-12" style="text-align:left;">	
						<div class="body2 delivery_text" style="text-align:left;margin-top:1.5rem; margin-bottom:0.5rem;">배송 메시지</div>
						<input type="text" class="body2 inputaddress delivery_text" style="background: #FFFFFF; padding-left:0.7rem;" placeholder="배송메세지를 입력해주세요." maxlength="200">
...
<!-- 					</div> -->
				...
				<input class="body2 pointinput2" type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" placeholder="0" style="border: 1px solid #DFE3E8; border-radius: 0.313rem; height:3rem; padding-left:0.7rem;">
...
<!-- 				배송 주소 부분 -->
				...
				<div class="row delivery-area" style="margin-left:0rem; width:100%">
					...
					<div class="col-12 phone" >
						...
						<div class="col-12" style="margin-bottom:0.5rem;"><input type="text" id="buyer_tel2" class="body2input buyer_tel"  placeholder="전화번호를 입력해 주세요." oninput="this.value = this.value.replace(/[^\d]/g, '').replace(/(\..*)\./g, '$1');"  maxlength="11" style="width:100%; padding-left:0.7rem;" value="${dto.phone }" ></div>
					</div>
					<div class="body2 col-12" style="margin-bottom:0.5rem;">배송지</div>
					<div class="col-12" style="margin-bottom:0.5rem;"><input type="text" class="body2 inputcode buyer_postcode zipcode" id="sample5_postcode" onclick="sample5_execDaumPostcode()" placeholder="우편번호 검색" style="margin-left:0rem; width:100%; padding-left:0.7rem;" value="${dto.postcode }" readonly></div> 
					
					<div class="col-12" style="margin-bottom:0.5rem;"><input type="text" class="body2 inputaddress buyer_addr address" id="sample5_roadAddress" placeholder="주소: 우편번호를 먼저 검색해 주세요."  style="width:17.5rem; margin-left:0rem; padding-left:0.7rem;" width:100%" value="${dto.address1 }" disabled></div>
					<div class="col-12" style="margin-bottom:0.5rem;"><input type="text" class="body2 inputaddress buyer_address2" placeholder="상세 주소 : 우편번호를 먼저 검색해 주세요."  id="sample5_detailAddress" style="width:100%; margin-left:0rem; padding-left:0.7rem;" value="${dto.address2 }"  maxlength="20"></div>
					<div class="body2 delivery_text" style="margin-bottom:0.5rem;">배송 메시지</div>
					<div class="col-12" style="margin-bottom:0.5rem;"><input type="text" class="body2 inputaddress delivery_text" style="background: #FFFFFF; width:100%; margin-left:0rem; padding-left:0.7rem;" placeholder="배송메세지를 입력해주세요." maxlength="200"></div>
					...
					<div class="row select_list" style="margin-left:-2.5rem; width:100%">
						...
						<div>
							...
							<div class="warp-pay" style="margin-bottom:4.5rem; margin-left:0rem;">
								...
								<div class="body2" style="margin-bottom:0.5rem;">포인트</div>
								<input class="body2 pointinput1" type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" placeholder="0" style="width:100%; margin-bottom:0.5rem; border: 1px solid #DFE3E8; border-radius: 0.313rem; height:3rem; padding-left:0.7rem;">
