		...
		<div class="container d-none d-sm-block"
			...
			<div class="row">
				...
				<div class="col-lg-2 col-xs-6">
					...
					<img src="/images/kidclass.png"
						style="margin-bottom: 20px; margin-top: 10px; width: 10.625rem; height: 14.125rem;">
					...
					<form action="/program/toApply" method="post">
						...
						<div class="col h2" id=po
							...
							<ul style="float: right; list-style:none;">
								<li style="float: left; margin-top: 5px;"><img src="/images/share.png" class="modalbtn share">
								<li style="float: right; margin-left: 15px;"><button class=bookbutton>신청하기</button>
							</ul>
							<input type=hidden name=count class=count1> <input
								type=hidden name=price class=price1>
				...
				<div class="col-12">
					...
					<form action="/Exhibition/toBook" method="post">
						...
						<div class="col h2"
							...
							<br>
							<img src="/images/share.png" class="modalbtn share">
							<button class=bookbutton
								style="text-align: center; margin-top: 3rem;">신청하기</button>
...
<script>
  ...
  Kakao.Link.createDefaultButton({
    ...
    objectType: 'feed',
    content: {
      title: "[Palet] 키즈워크룸 : 애니메이터 프로젝트", // 보여질 제목
      description: "클래스 바로 예약하기", // 보여질 설명
