	...
	<div class="container-fluid">
		...
		<div class=container>
			<div class=row>
				<div class="col-12">
					<div class=row>
						<div class="col-lg-7 col-12 " style = padding-left:0px;>
							<div class="row rec1">
								...
								<div class=col-12 style="margin-top: 0.5rem;">
									<input type=text class=input1 id="email"
						...
						<div class="col-lg-4 col-12" style ="padding-left:0px;">
							<div class="row  rec1 h-50" id=row2>
								<div class="col-6 h3" style="text-align: left;">총 결제 금액</div>
								<div class="col-6 h3" style="text-align: right;">${price }</div>
								<div class="col-6 caption"
									style="text-align: left; margin-top: 1rem;">적립예정 포인트</div>
								<div class="col-6 caption"
									style="text-align: right; margin-top: 1rem;">940p</div>
								<div class="col-12" style="padding: 0px; text-align: center; height:3.75rem;">
									<button class="btn1_1" id=pay onclick="iamport()" style = "display:inline-block;">결제하기</button>
								</div>
							</div>
	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row" style="margin-top: 1.25rem;">
				<div class="col-12 col-lg-8 rec1">
				...
				<div class="col-12 col-lg-4 rec1" >
					...
					<div class="row" id="row1 " style="margin-top: 2.6rem;">
	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row" style="margin-top: 1.25rem; padding-left: 2.5rem;">
				...
				<div class="col-4 col-xs-6 rec1"
					style="padding: 1.75rem; width: 23.5rem; height: 7.125rem; margin-left: 2.25rem;">
					<div class="row h3" id="row1" style="margin: 0px;">
						<div class=col-6 style="text-align: left;">총 결제 금액</div>
						<div class=col-6 style="text-align: right;">${price }</div>
