			...
			<div class="row">
				...
				<div class="col-lg-9 col-xs-12">
					...
					<form action="/Exhibition/toBook" method="post">
						<input type=hidden name=count id=count1> <input
							type=hidden name=price id=price1>


						<div class="col h2" id = po
							style="text-align: left; margin-top: 5.781rem;">
							<span class=h2 id=price name="price">9,000원</span> <img
								src="/images/minusbutton.png" type="button"
								style="margin-left: 1.5rem; width: 3.75rem; height: 3.75rem;"
								id=minusbutton> <span id=count class=body1
								style="color: #161C24; margin-left: 1rem;">1</span> <img
								type="button" id=plusbutton src="/images/plusbutton.png"
		...
		<div class="container d-block d-sm-none"
			...
			<div class="row">
				...
				<div class="col-12">
					...
					<div class="col h3"  style="text-align: center; margin-top:3rem; ">Romantic Days 어쨌든, 사랑</div>
					...
					<button class=bookbutton style ="text-align: center;  margin-top:3rem;">예매하기</button>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<ul class="col-12 ul2 h3 offset d-block d-sm-none"
					...
					<li style="width: 4.938rem;  text-align: center; margin-left: 2.6rem; margin-right: 2.6rem;">전시소개</li>
					<li style="width: 4.938rem;  text-align: center;  color: #919EAB; margin-left: 2.6rem;; margin-right: 2.6rem;"><a
						class="exlink">전시굿즈</a></li>
					<li style="width: 4.938rem;  color: #919EAB;  text-align: center; margin-left: 2.6rem;;margin-right: 2.6rem;">SNS후기</li>
			...
			<div class="row" id=row1>
				...
				<img
					...
					style="margin: auto; 	padding-left: 2.5rem;
	padding-right: 2.5rem; text-align: center; width: 100%;">
			</div>
...
$(".bookbutton").on("click", function() {
	$("#count1").val($("#count").text());
	$("#price1").val($("#price").text());
					...
					<div class="col-9">
						...
						<div class="row" id="row1" style="margin-top: 5.781rem;">
							<div class="col h2" style="text-align: left;">
								<span id = price name = "price" >139,000원</span> 
