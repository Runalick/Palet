...
<body>
<div class="h3">개인정보 수집 및 이용</div>
<hr style="background:#454F5B ;height: 3px; margin-bottom: 10px;">

<div class="body">
(주)팔레트'는 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
...
ο 개인정보 수집방법 :<br>
- 홈페이지(회원가입) , 서면양식으로 수집<br>
- 휴대폰 인증 시 : 성명, 생년월일, 성별, 휴대폰 본인인증 정보(CI, DI)<br>
</div>

<div class="h4">■ 개인정보의 수집 및 이용목적</div>
<div class="body">
...
<div class="h4">■ 개인정보의 보유 및 이용기간</div>
<div class="body">
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.<br>
</div>


<div class="h4">■ 개인정보의 파기절차 및 방법</div>
<div class="body">
...
<div class="h4">■ 수집한 개인정보의 위탁</div>
<div class="body">
회사는 서비스 이행을 위해 아래와 같이 외부 전문업체에 위탁하여 운영하고 있습니다.<br>
위탁 대상자: (주)셀러드랩<br>
위탁업무 내용: 게시판 시스템 및 마일리지 시스템 구축/유지/보수, DM발송<br>
</div>


<div class="h4">■ 이용자 및 법정대리인의 권리와 그 행사방법</div>
<div class="body">
...
<div class="h4">■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</div>
<div class="body">
...
<div class="h4">■ 개인정보에 관한 민원서비스</div>
<div class="body">
회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.<br>
고객서비스담당 부서 :고객관리팀<br>
전화번호 : 02-324-8849<br>
이메일 : contact@rawrow.com<br>
개인정보관리책임자 성명 : 이의현<br>
전화번호 : 02-336-2891<br>
이메일 : contact@rawrow.com<br>
...
ο 개인정보 수집방법 :<br>
- 홈페이지(회원가입) , 서면양식으로 수집<br>
- 휴대폰 인증 시 : 성명, 생년월일, 성별, 휴대폰본인인증정보(CI, DI)<br>
</div>
