...
<body>
<div class="h3">이용약관</div>
<hr style="background:#454F5B ;height: 3px; margin-bottom: 10px;">
<div class="h4">제1조(목적)</div>	
<div class="body">
이 약관은 (주)팔레트 (전자상거래 사업자)가 운영하는 팔레트 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리.의무 및 책임사항을 규정함을 목적으로 합니다.<br>		
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」<br>
</div>		
<div class="h4">제2조(정의)	</div>	
<div class="body">
...
<div class="h4">제3조 (약관 등의 명시와 설명 및 개정)</div>
<div class="body">		
...
<div class="h4">제4조(서비스의 제공 및 변경)</div>
<div class="body">		
...
<div class="h4">제7조(회원 탈퇴 및 자격 상실 등)</div>	
<div class="body">	
...
<div class="h4">제8조(회원에 대한 통지)</div>
<div class="body">		
...
<div class="h4">제12조(수신확인통지.구매신청 변경 및 취소)</div>
<div class="body">	
...
<div class="h4">제13조(재화 등의 공급)	</div>	
<div class="body">
...
<div class="h4">제16조(청약철회 등의 효과)</div>	
<div class="body">	
...
<div class="h4">제19조(회원의 ID 및 비밀번호에 대한 의무)	</div>	
<div class="body">
...
<div class="h4">제21조(연결“몰”과 피연결“몰” 간의 관계)	</div>	
<div class="body">
...
<div class="h4">제22조(저작권의 귀속 및 이용제한)</div>		
<div class="body">
...
<div class="h4">제24조(재판권 및 준거법)</div>
<div class="body">		
