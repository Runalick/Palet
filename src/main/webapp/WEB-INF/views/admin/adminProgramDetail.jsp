            ...
            <div class="row">    
            	<div class="col-xl-10 col-lg-9 col-md-8 ml-auto" id="dashMain">  <!-- 추후CSS작업 시 바뀔이름 -->
            		<div class="row" style="margin-top: 5rem">
						<div class="col-12 h3_1 px-5" style="text-align:left"> <img src="/images/minus.png"> Programs Detail View </div>
                		<div class="col-12 body2 colortext_gray600 px-5" >  : 프로그램 페이지 입니다. </div>
                	</div>
