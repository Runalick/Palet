...
<!-- 카카오 지도 -->
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=99c850f0f233688fd849392cba2bd5bd"></script>
<!-- 카카오 로그인 -->
...
<body style = "overflow-x:hidden;">
		...
		<div class = "col h3" style = "margin-top:10rem; text-align:center; color : #ffa48d; font-size:25px; line-height:3rem;">협력 미술관 &nbsp;&nbsp;: &nbsp;&nbsp;디뮤지엄, &nbsp;&nbsp;국립현대미술관</div>
...
이 두 단어를 합성하여 만들어진 ‘palet’라는 이름는 ‘여러가지 색을 가진 다양한 작품, 다채로운 즐거움을 전달하자’는 의미를 담고있습니다.</div>
		...
		<div class="col-12">
			<div class="row" id="row1" style="padding:0.8rem; margin-bottom:5rem;">
